...
A special acknowledgement to the University of Irvine Data Repository for providing this dataset. 
...
* Conditional independence assumption is not always true as there are cases where features are depedent on each other.
